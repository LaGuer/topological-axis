...
\node [anchor = text=black] at (-10.,33.75) {\small{Caracteristics length follow the law: $exp(2^{d/4})$}};
\node [anchor = text=black] at (-13.,32.75) {\small{Unit length: electron Compton reduced wavelength $\hbar m_e c=\lambdabar_e$}};
\node [anchor = text=black] at (-15.,31.75) {\small{Super Period unit: $\lambdabar_e/c$. Photonde and Gravitonde masses unit: $2\pi m_N$}};
